...
export function Onboarding() {
	...
	const getStepTitle = () => {
		switch (step) {
			case 0:
				return "Welcome to INITIUM Cut Beta! 🎉";
				case 1:
				return "⚠️ This is a super early beta!";
				case 2:
				return "🦋 Have fun testing!";
				default:
				return "INITIUM Cut Onboarding";
		}
	};
				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title="Welcome to INITIUM Cut Beta! 🎉" />
							<Description description="You're among the first to try INITIUM Cut — a fully open source video editor built for property marketing." />
						</div>
				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title={getStepTitle()} />
							<Description
								description={`Join our [Discord](${SOCIAL_LINKS.discord}), chat with the team and share feedback to help make INITIUM Cut the best editor for property videos.`}
							/>
						</div>
